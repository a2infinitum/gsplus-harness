...
"  watch <bank>/<addr> [len] [n|stop]  report every write with the writing\n"
"                           PC and a 1 MHz cycle stamp (n = trace lines per\n"
"                           hit, stop = halt on the\n"
"                           write instead); watch off clears; needs -logpc\n"
"  trace [n]                dump the last n instructions (needs -logpc)\n"
